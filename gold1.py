...
class jugador(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.imagenCarro = pygame.image.load("imagenes/sprites_gold.png").convert_alpha()
        self.imagenCarro.set_clip(pygame.Rect(126,26,185,26))
        self.imagen = self.imagenCarro.subsurface(self.imagenCarro.get_clip())
        ...
        self.frame = 0
        """ animacion """
        self.right_states = {0: (41,26,100,26),1:(126,26,100,26),2:(213,26,100,26)}
